...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    batch_norm1 = BatchNormalization(name="batch_norm1")(conv_1d)
    
    bidirectional = Bidirectional(GRU(units, activation="relu",return_sequences=True, 
             implementation=2, name="bidirectional"))(batch_norm1)
    
    batch_norm2 = BatchNormalization(name="batch_norm2")(bidirectional)
